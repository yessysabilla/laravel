...
<head>
    ...
    <title>{{ $title ?? 'Erzertzy @ ErzertzyBlog' }} | Dashboard</title>
        ...
        <div class="wrapper">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <img src="{{ asset('assets/dist/img/user7-128x128.jpg') }}" alt="User Avatar"
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ route('home') }}" class="brand-link">
                    ...
                    <span class="brand-text font-weight-light">{{ $title ?? 'ErzertzyBlog' }}</span>
                </a>
